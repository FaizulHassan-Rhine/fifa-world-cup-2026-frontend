...
function CommentaryRow({ item }) {
  ...
  return (
    <div className="grid min-w-0 grid-cols-[2rem_1.5rem_minmax(0,1fr)] items-start gap-2 border-b border-zinc-800/60 px-1.5 py-2.5 last:border-b-0 sm:grid-cols-[2.5rem_2rem_1fr] sm:gap-2.5 sm:px-2 sm:py-3">
